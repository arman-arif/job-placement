            ...
            <div class="maincontent fix">
              <hr>
                <div class="text-center text-uppercase m-4">
                  <a href="/student-register" class="btn btn-primary">Student register</a>
                  <a href="/company-register" class="btn btn-secondary">Company register</a>
                  <a href="/teacher-register" class="btn btn-secondary">Teacher register</a>
                </div><hr>
                <h3 class="text-center text-uppercase m-3">Student Signup Form</h3>
                <div class="row">
                    ...
                    <div class="col-md">
                        ...
                        <form class="needs-validation" method="post" novalidate>
                          <div class="form">
                            <div class="mb-3">
                              <input type="text" name="name" class="form-control" id="validationCustom01" placeholder="Student Name" required>
                            ...
                            <div class="mb-3">
                              <input type="text" name="session" class="form-control" id="validationCustom06" placeholder="Session" required>
                              <div class="invalid-feedback">
                                Please enter your session.
                              </div>
                            </div>
                            <div class="mb-3">
                              <input type="text" name="passing_year" class="form-control" id="validationCustom07" placeholder="Passing year" required>
                              <div class="invalid-feedback">
