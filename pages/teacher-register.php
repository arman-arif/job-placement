            ...
            <div class="maincontent fix">
              <hr>
                <div class="text-center text-uppercase m-4">
                  ...
                  <a href="/teacher-register" class="btn btn-primary">Teacher register</a>
                </div><hr>
                <h3 class="text-center text-uppercase m-3">Teacher Signup Form</h3>
                <div class="row">
                    ...
                    <div class="col-md">
                        ...
                        <form class="needs-validation" method="post" novalidate>
                          <div class="form">
                            <div class="mb-3">
                              <input type="text" name="name" class="form-control" id="validationCustom01" placeholder="Teacher Name" required>
                            ...
                            <div class="mb-3">
                              <input type="text" name="title" class="form-control" id="validationCustom06" placeholder="Title" required>
                              <div class="invalid-feedback">
                          ...
                          <button class="btn btn-danger btn-block" type="submit" name="tec-reg">Sign up</button>
                        </form>
                    </div>
                    <div class="col-md"></div>
                </div>
