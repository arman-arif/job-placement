			...
			<table class="table table-striped table-sm">
				...
				<tr>
					...
					<td class="text-center">
						<a class="text text-success" href="/student-cv?student=<?php echo $row['student_username'] ?>" target="_blank">View CV</a> |
						<a class="text text-danger" href="delete.php?id=<?php echo $row['id'] ?>&table=applications">Delete</a>
					</td>
				</tr>
				<?php } ?>
			</table>
